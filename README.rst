...
Copyright 2009 Satpy developers
...
The EPS format description ``satpy/etc/eps_avhrrl1b_6.5.xml`` is an
unmodified third-party file, copyright EUMETSAT, distributed under the terms
of the GNU General Public License version 2 or later, and keeps its own
license notice.
