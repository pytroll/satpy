...
from mpop.instruments.seviri import SeviriScene
from mpop.logger import LOG
import mpop.imageo.palettes
import mpop.imageo.image_processing
...
class Meteosat09SeviriScene(SeviriScene):
    ...
    def load(self, channels=None, load_again=False, **kwargs):
        ...
        SeviriScene.load(self, channels_to_load, load_again, **kwargs)
        ...
        if channels is not None:
            ...
            if("CloudType" in channels and
               "CloudType" not in self.channels):
                import mpop.satin.msg_ctype
                self.channels.append(
                    mpop.satin.msg_ctype.cloudtype_channel(self.time_slot,
                                                           self.area))
    ...
    def pge02c(self):
        ...
        palette = mpop.imageo.palettes.tv_legend()
    ...
    def pge03(self):
        ...
        ctth = mpop.satin.msg_ctth.msg_ctth2ppsformat(self["CTTH"])
    ...
    def nordrad(self):
        ...
        return mpop.satin.msg_ctype.NordRadCType(self["CloudType"], datestr)
