...
-------------------
- Update changelog. [davidh-ssec]
- Bump version: 0.8.1 → 0.8.2. [davidh-ssec]
- Fix readers so yaml and reader names match. [davidh-ssec]
- Fix nc_olci_l1b reader so config yaml matches reader name. [davidh-
  ssec]
- Update abi_l1b.yaml to allow C01 filename. [howff]

  C01 filename from Eumetcast has -{chid:6d}_0 suffix just like C02

  (cherry picked from commit 3bc63b6)

- Make flake8 happy. [Martin Raspaud]

  (cherry picked from commit 04e753d)

- Fix the nc_nwcsaf_pps reader config for file finding compatibility.
  [Martin Raspaud]

  (cherry picked from commit e2355ef)

- Merge pull request #177 from pytroll/bugfix-viirs. [David Hoese]
