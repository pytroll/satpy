...
A simple example config is shown below the code example.

As an example, reading SEVIRI HRIT data from a local S3 storage can be done in the following way::
