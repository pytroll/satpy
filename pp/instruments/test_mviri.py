...
"""Module for testing the :mod:`pp.instruments.mviri` module.
"""
import unittest

import pp.instruments.mviri
import pp.scene
...
class TestComposites(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patch_geo_image()
        patch_scene()
        self.scene = pp.instruments.mviri.MviriScene()
