...
"""satpy netcdf4 writer interface.
"""
...
def save(scene, filename, compression=True, dtype=np.int16, band_axis=2):
    ...
    *band_axis* gives the which axis to use for the band dimension. For
    ...
    """
    from satpy.satout.cfscene import CFScene

    scene.add_to_history("Saved as netcdf4/cf by pytroll/satpy.")
...
if __name__ == '__main__':
    from satpy.satellites.meteosat09 import Meteosat09SeviriScene
    import datetime
