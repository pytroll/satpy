...
class NCMERISCal(NCMERISBase):
    """Dummy class for calibration."""

    pass


class NCMERISGeo(NCMERISBase):
...
class NCMERIS2(NCMERISChannelBase):
...
class NCMERISAngles(NCMERISLowResData):
...
class NCMERISMeteo(NCMERISLowResData):
