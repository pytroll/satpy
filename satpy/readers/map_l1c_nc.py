...
"""EUMETSAT CO2M Multi-Angle Polarimeter (MAP) Level 1C products reader.

The ``map_l1c_nc`` reader reads and calibrates CO2M MAP L1c image data in netCDF format. The format is explained
in the `CO2M MAP Level 1B Product Format Specification V2L`_.

This version is an initial draft trial version.

.. _CO2M MAP Level 1C Product Format Specification V2L draft: https://www.eumetsat.int/media/44393
...
from satpy.readers.map_base_nc import MapNCBaseFileHandler
#from satpy.readers.vii_utils import C1, C2, MEAN_EARTH_RADIUS

logger = logging.getLogger(__name__)


class MapL1cNCFileHandler(MapNCBaseFileHandler):
    """Reader class for MAP L1C products in netCDF format."""
    ...
    #    if calibration_name == 'reflectance':
