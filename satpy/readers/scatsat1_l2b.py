...
class SCATSAT1L2BFileHandler(BaseFileHandler):
    ...
    def __init__(self, filename, filename_info, filetype_info):
        ...
        self.wind_speed_scale = \
            float(h5data.attrs['Wind Speed Selection Scale'])
        self.wind_direction_scale = \
            float(h5data.attrs['Wind Direction Selection Scale'])
        self.latitude_scale = \
            float(h5data.attrs['Latitude Scale'])
        self.longitude_scale = \
            float(h5data.attrs['Longitude Scale'])
