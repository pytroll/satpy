...
def __getattr__(name: str) -> Any:
    from .core import yaml_reader

    new_submod = "core.yaml_reader"
    obj = getattr(yaml_reader, name)

    warnings.warn(
        f"'satpy.readers.yaml_reader.{name}' has been moved to 'satpy.readers.{new_submod}.{name}'. "
