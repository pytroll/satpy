...
def __getattr__(name: str) -> Any:
    from .core import xmlformat

    new_submod = "core.xmlformat"
    obj = getattr(xmlformat, name)

    warnings.warn(
        f"'satpy.readers.xmlformat.{name}' has been moved to 'satpy.readers.{new_submod}.{name}'. "
