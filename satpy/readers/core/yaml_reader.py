...
class AbstractYAMLReader(metaclass=ABCMeta):
    ...
    def sensor_names(self):
        ...
        return self.info["instruments"] or []
    ...
    def supports_sensor(self, sensor):
        ...
        """
        if sensor and not (set(self.info.get("instruments")) &
...
class FileYAMLReader(GenericYAMLReader, DataDownloadMixin):
    ...
    def _make_swath_definition_from_lons_lats(self, lons, lats):
        ...
        if sdef is None:
            ...
            sensor_str = "_".join(self.info["instruments"])
...
class GEOVariableSegmentYAMLReader(GEOSegmentYAMLReader):
    ...
    For more information on please see the documentation of :func:`satpy.readers.core.yaml_reader.GEOSegmentYAMLReader`.
    """
