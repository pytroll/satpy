...
class MsgCloudType(satpy.channel.GenericChannel):
...
# ------------------------------------------------------------------
    ...
    def convert2pps(self):
        from satpy.satin.nwcsaf_pps import CloudType
...
# ------------------------------------------------------------------
    ...
    def convert2pps(self):
        """Convert the current CTTH channel to pps format.
        """
        from satpy.satin.nwcsaf_pps import CloudTopTemperatureHeight
