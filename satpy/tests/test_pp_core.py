...
class TestPPCore(unittest.TestCase):
    """Class for testing the core of satpy.
    """
    ...
    def setUp(self):
        ...
        self.scene = satpy.scene.SatelliteInstrumentScene()
    ...
    def test_channel_list_syntax(self):
        ...
        class Satscene(satpy.scene.SatelliteInstrumentScene):
        ...
        for i, chn in enumerate(self.scene.channels):
            self.assertTrue(isinstance(chn, satpy.channel.Channel))
