...
class TestReflectanceCorrectorModifier:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("C01", (0.45, 0.47, 0.49), 1000, 44.757951222645104,
            ...
            ("C02", (0.59, 0.64, 0.69), 500, 51.49009261432518,
            ...
            ("C03", (0.8455, 0.865, 0.8845), 1000, 50.724336985203905,
            ...
            ("C05", (1.58, 1.61, 1.64), 1000, 52.723082260002045,
            ...
            ("C06", (2.225, 2.25, 2.275), 2000, 55.973458829136796,
