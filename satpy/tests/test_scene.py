...
class TestScene(unittest.TestCase):
    ...
    def test_init_alone(self):
        from satpy.scene import Scene
        from satpy import PACKAGE_CONFIG_PATH
        scn = Scene()
...
# from satpy.channel import NotLoadedError
# from satpy.scene import SatelliteScene, SatelliteInstrumentScene
#
#
...
#         return area
#
#     satpy.projector.OldProjector = satpy.projector.Projector
#     satpy.projector.Projector = FakeProjector
#     satpy.projector.old_get_area_def = satpy.projector.get_area_def
#     satpy.projector.get_area_def = fake_get_area_def
#
#
# def unpatch_projector():
#     """Unpatch fake projector
#     """
#     satpy.projector.Projector = satpy.projector.OldProjector
#     delattr(satpy.projector, "OldProjector")
#     satpy.projector.get_area_def = satpy.projector.old_get_area_def
#     delattr(satpy.projector, "old_get_area_def")
#
#
...
#     #                                                dtype = int))
#
#     #     big_scene = satpy.scene.assemble_segments([self.scene, scene2])
#
