...
"""Unittesting the GLD360 ualf2 reader."""
...
from satpy.readers.gld360_ualf2 import Gld360Ualf2FileHandler
from satpy.tests.utils import make_dataid


class TestVaisalaGLD360TextFileHandler(unittest.TestCase):
    """Test the Gld360Ualf2FileHandler."""
    ...
    def test_vaisala_gld360(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w') as t:
            ...
            self.handler = Gld360Ualf2FileHandler(
