...
class TestGeosNetcdfIcareReader() :
    ...
    def test_geosNetcdficare(self, tmp_path) :
        ...
        logger.info("The picture should be pink.")
    ...
    def init(self, tmp_path) :
        ...
        # logger.info(self.scn.available_dataset_names())
        # ['IR_016', 'IR_039', 'IR_087', 'IR_097', 'IR_108', 'IR_120',
        # 'IR_134', 'VIS006', 'VIS008', 'WV_062', 'WV_073']

        # logger.info(self.scn.available_composite_names())
        ...
        'optional_prerequisites': []}
        ['airmass', 'ash', 'cloud_phase_distinction', ...
    ...
    def visibleChannelsCreation(self, ncfileOut, fill_value) :
        for channel in {"VIS006", "VIS008", "IR_016"} :
            ...
            var[:] = np.array(
                ([[i * 2 for i in range(3712)] for j in range(3712)]))
