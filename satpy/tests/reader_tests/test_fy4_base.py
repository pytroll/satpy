...
"""The FY4 base reader tests package."""
...
from satpy.readers.fy4_base import RESOLUTION_LIST_AGRI
...
class Test_HDF_AGRI_L1_cal:
    ...
    def test_fy4a_channels_are_loaded_with_right_resolution(self):
        ...
        reader = self._create_reader_for_resolutions(*RESOLUTION_LIST_AGRI)

        available_datasets = reader.available_dataset_ids

        for resolution_to_test in RESOLUTION_LIST_AGRI:
    ...
    @pytest.mark.parametrize("resolution_to_test", RESOLUTION_LIST_AGRI)
    ...
    def _assert_which_channels_are_loaded(available_datasets, band_names, resolution_to_test):
        ...
        other_resolutions = RESOLUTION_LIST_AGRI.copy()
