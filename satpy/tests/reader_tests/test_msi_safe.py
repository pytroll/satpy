...
class TestTileXML:
    ...
    @pytest.mark.parametrize(("angle_name", "angle_block", "angle_type", "expected"),
                             [("satellite_zenith_angle", "Viewing_Incidence_Angles_Grids", "Zenith",
                                  ...
                                  [3.7708, 3.7708, 3.7708, 3.7708, 3.7708,
                                   3.7708, 3.7708, 3.7708, 3.7708, 3.24140837]]),
                              ("solar_zenith_angle_l2a", "Sun_Angles_Grid", "Zenith",
...
class TestMTDXML:
    ...
    def test_satellite_zenith_array(self):
        ...
        res1 = self.l1c_xml_tile_fh.get_dataset(make_dataid(name="satellite_zenith_angle",
                                                            resolution=60),
                                                info)[::200, ::200]
        res2 = self.l1c_xml_tile_fh.get_dataset(make_dataid(name="satellite_zenith_angle_l2a",
                                                       resolution=60),
                                           info)[::200, ::200]
        np.testing.assert_allclose(res1, expected_data)
        np.testing.assert_allclose(res2, expected_data)
