...
class TestFileHandler:
    ...
    def patch_number_of_pixels_per_scanline(self, monkeypatch):
        ...
        IMAGE_DATA_BLOCK_VIS = np.dtype([('LCW', vissr.LINE_CONTROL_WORD),
                      ('DOC', vissr.U1, (64,)),
                      ('image_data', vissr.U1, (num_pixels,))])
        IMAGE_DATA = {
            vissr.VIS_CHANNEL: {
        ...
        monkeypatch.setattr(
            "satpy.readers.gms5_vissr_l1b.IMAGE_DATA_BLOCK_IR",
            IMAGE_DATA_BLOCK_IR
        )
        monkeypatch.setattr(
            "satpy.readers.gms5_vissr_l1b.IMAGE_DATA_BLOCK_VIS",
            IMAGE_DATA_BLOCK_VIS
        )
        monkeypatch.setattr(
            "satpy.readers.gms5_vissr_l1b.IMAGE_DATA",
            IMAGE_DATA
        )
