...
TEST_AREA_EXTENT_EARTHMODEL1_HRV_FULLDISK = {
    ...
    'expected_area_def': {
        ...
        'Area extent 0': (5568748.0545043945, 2624352.5314331055, 0.0, -5568748.0545043945),
        'Area extent 1': (3603484.0589761734, 5568748.0545043945, -1965263.9955282211, 2624352.5314331055)
    }
}
...
TEST_AREA_EXTENT_EARTHMODEL1_HRV_ROI = {
    ...
    'expected_area_def': {
        ...
        'Number of rows': 11136,
        'Area extent': (5335716.751217842, 5154692.4340724945, -2205296.239256859, -331044.46947574615)
    }
}
...
TEST_AREA_EXTENT_EARTHMODEL2_HRV_FULLDISK = {
    ...
    'expected_area_def': {
        ...
        'Number of columns': 5568,
        'Number of rows': 11136,
        'Area extent 0': (5567247.852981091, 2625852.7329564095, -1500.2015233039856, -5567247.852981091),
        'Area extent 1': (3601983.8574528694, 5570248.2560276985, -1966764.197051525, 2625852.7329564095)
    }
}
...
TEST_AREA_EXTENT_EARTHMODEL2_HRV_ROI = {
    ...
    'expected_area_def': {
        ...
        'Number of columns': 11136,
        'Number of rows': 11136,
        'Area extent': (5334216.549694538, 5156192.6355957985, -2206796.440780163, -329544.26795244217)
    }
}
