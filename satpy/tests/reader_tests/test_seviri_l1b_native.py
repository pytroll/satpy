...
class TestNativeMSGFilenames:
    ...
    def test_file_pattern(self, reader):
        ...
        filenames = [
            ...
            "MSG2-SEVI-MSG15-0201-NA-20080219094242.289000000Z-123456.nat",
            "MSG2-SEVI-MSG15-0201-NA-20080219094242.289000000Z-20201231181545-123456.nat",
            # Invalid
            "MSG2-SEVI-MSG15-0100-NA-20080219094242.289000000",
            "MSG2-SEVI-MSG15-0201-NA-20080219094242.289000000Z-123456",
        ]
