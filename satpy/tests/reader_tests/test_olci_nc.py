...
class TestOLCIReader(unittest.TestCase):
    ...
    def test_instantiate(self, mocked_dataset):
        ...
        ds_id = make_dsid(name='Oa01', calibration='reflectance')
        ds_id2 = make_dsid(name='wsqf', calibration='reflectance')
    ...
    def test_olci_angles(self, mocked_dataset):
        ...
        ds_id = make_dsid(name='solar_azimuth_angle')
        ds_id2 = make_dsid(name='satellite_zenith_angle')
    ...
    def test_olci_meteo(self, mocked_dataset):
        ...
        ds_id = make_dsid(name='humidity')
        ds_id2 = make_dsid(name='total_ozone')
