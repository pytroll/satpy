...
@pytest.mark.parametrize(
    ...
    [
        ...
        (("auto", "auto"), (21696 // 2, 21696 // 2), (226, 226), (2, 2), np.float32, (1356, 1356)),
        # 1km area (64-bit)
        (("auto", "auto"), (21696 // 2, 21696 // 2), (226, 226), (2, 2), np.float64, (1017, 1017)),
        # 3km area
        (("auto", "auto"), (21696 // 3, 21696 // 3), (226, 226), (6, 6), np.float32, (1356 // 3, 1356 // 3)),
        # 500m area
        (("auto", "auto"), (21696, 21696), (226, 226), (1, 1), np.float32, (1356 * 2, 1356 * 2)),
