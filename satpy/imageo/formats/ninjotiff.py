...
import satpy.imageo.formats.libtiff as libtiff
from satpy.imageo.formats.libtiff import TIFF, TIFFFieldInfo, TIFFDataType, FIELD_CUSTOM
...
def _finalize(geo_image):
    """Finalize a satpy GeoImage for Ninjo. Specialy take care of phycical scale
    and offset.

    :Parameters:
        geo_image : satpy.imageo.geo_image.GeoImage
            See satpy's documentation.
...
def save(geo_image, filename, ninjo_product_name=None, **kwargs):
    """satpy's interface to Ninjo TIFF writer.
