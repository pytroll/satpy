...
class DayNightCompositor(GenericCompositor):
    ...
    def __call__(self, projectables, **kwargs):
        ...
        # LA/RGB -> RGBA/RGBA
        # RGB/RGBA -> RGBA/RGBA
        background_bands = new_background_data['bands'] if 'A' not in background_data['bands'].data else \
                           background_data['bands']
        foreground_bands = new_foreground_data['bands'] if 'A' not in foreground_data['bands'].data else \
                           foreground_data['bands']
